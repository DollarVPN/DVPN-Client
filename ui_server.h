...
"}"));
        ...
        label_3->setGeometry(QRect(7, -5, 8, 101));
        label_3->setStyleSheet(QLatin1String("QLabel\n"
"{\n"
"background-color:#ffb400;\n"
"}"));
        country_name = new QLabel(frame);
        country_name->setObjectName(QStringLiteral("country_name"));
        country_name->setGeometry(QRect(70, 13, 81, 16));
        QFont font;
        font.setPointSize(8);
        font.setBold(true);
        font.setWeight(75);
        country_name->setFont(font);
        country_name->setStyleSheet(QLatin1String("QLabel\n"
"{\n"
"color:#ffffff;\n"
"background-color:#2b2d3c;\n"
"}"));
        country_name->setTextFormat(Qt::AutoText);
        location = new QLabel(frame);
        location->setObjectName(QStringLiteral("location"));
        location->setGeometry(QRect(70, 28, 81, 16));
        QFont font1;
        font1.setPointSize(8);
        location->setFont(font1);
        location->setStyleSheet(QLatin1String("QLabel\n"
"{\n"
"color:#616474;\n"
"background-color:#2b2d3c;\n"
"}"));
        ...
        disconn->setGeometry(QRect(764, 11, 110, 35));
...
"}"));
        ...
        label_2->setGeometry(QRect(342, 20, 81, 16));
...
"}"));
        ...
        label->setGeometry(QRect(209, 20, 41, 16));
...
"}"));
    ...
    void retranslateUi(QWidget *Server)
    {
        ...
        country_name->setText(QApplication::translate("Server", "Netherlands", Q_NULLPTR));
        location->setText(QApplication::translate("Server", "Amsterdam", Q_NULLPTR));
        disconn->setText(QApplication::translate("Server", "Disconnect", Q_NULLPTR));
